...
import { getCurrentUser, listarNegocios } from "../services/api";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {negocios.map((negocio) => (
                  <div
                    ...
                    onClick={() => {
                      // TODO: Navegar a la página de detalle del negocio
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            // TODO: Implementar acciones del negocio
                            console.log("Acciones:", negocio);
                          }}
