 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (token) {
      ...
      idUsuario = user.id_usuario; // este es el que usas en el ms_negocios
    }
    ...
    // 👇 2. Armar el payload incluyendo id_usuario
    const submitData = {
    ...
    if (contentType && contentType.includes("application/json")) {
      ...
      showNotification(
        "Error del servidor. Revisa la consola para más detalles.",
        "error"
      );
      return;
    }
    ...
    showNotification(
      "Error de red al contactar el servidor. Asegúrate de que el servidor esté corriendo.",
      "error"
    );
  }
};
